...
sts_client_id = sys.argv[6]
sts_client_password = sys.argv[7]
kc_server = sys.argv[8]
kc_client_id = sys.argv[9]
kc_client_secret = sys.argv[10]
thumbprint_file = sys.argv[11]
